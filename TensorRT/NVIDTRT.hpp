...
void test(NVID::Type type, NVID::Mode mode, const std::string& model);
void inference_and_performance(int deviceid, const std::string& engine_file, NVID::Mode mode, NVID::Type type, const std::string& model_name);
bool exists(const std::string& path);
std::string get_file_name(const std::string& path, bool include_suffix);
