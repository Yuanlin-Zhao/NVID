...
def make_parser():
    ...
    parser.add_argument(
        "--path", default=r"D:/aaa--videodetection/YOLOV-master/2.mp4", help="path to images or video"
    )
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default=r'D:/aaa--videodetection/YOLOV-master/exps/yolov/yolov_s.py',
        type=str,
        help="pls input your expriment description file",
    )
    parser.add_argument("-c", "--ckpt", default=r'D:/aaa--videodetection/YOLOV-master/weights/yolov_s.pth', type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
    ...
    parser.add_argument('--output_dir', default=r'D:/aaa--videodetection/YOLOV-master/output',
...
class Predictor(object):
    ...
    def inference(self, img,img_path=None):
        ...
        with torch.no_grad():
            ...
            #outputs,outputs_ori = self.model(img, 0.5)
